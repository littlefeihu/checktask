...
{
	public class LNLegalAndProfessionalFragment: Fragment, ISettingsBoardFragment
	{
		...
		public string Title
		{
			get
			{
				return SettingsBoardActivity.GetTitle(SettingsBoardActivity.LNLegalAndProfessional);
			}
		}
