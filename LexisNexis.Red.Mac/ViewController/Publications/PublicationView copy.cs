...
//
		...
		void ShowDownloadBtnView (bool isShow)
		{
			...
			if (downloadButton == null) {
				...
				downloadButton.Cell.SetButtonType (NSButtonType.MomentaryPushIn);
		...
		#region Action
		[Action("DownloadBook:")]
		void DownloadBook (NSObject sender)
		{
			...
			DownloadController.StartDownloadWithoutLimitation (BookInfo.BookId, isUpdate);
		}
...
//			}
		...
		//deal with update from info modal
		void HandleFinishDownload(NSNotification notification) 
		{
		...
		static nfloat HeightWrappedWidth (NSTextField sourceTextField, nfloat fontSize)
		{
		...
		//
		#if false
		static CGRect updateViewFrame = new CGRect (PUBLICATION_DOWN_ORGX,
															PUBLICATION_DOWN_ORGY,
															PUBLICATION_DOWN_WIDTH,
															PUBLICATION_DOWN_ORGX);
		#endif
