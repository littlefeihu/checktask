...
{
	public partial class SearchResultViewController : NSViewController
	{
		#region properties
		...
		public SearchResultViewController (NSCoder coder) : base (coder)
		{
			Initialize ();
		}

		// Call to load from the XIB/NIB file
		public SearchResultViewController (NSPopover popover, int bookID, string keyword) : base ("SearchResultView", NSBundle.MainBundle)
		{
		...
		public new SearchResultView View {
			get {
				return (SearchResultView)base.View;
			}
		}
