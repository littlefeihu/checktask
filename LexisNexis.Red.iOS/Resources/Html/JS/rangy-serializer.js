    ...
    rangy.createModule("Serializer", ["WrappedSelection"], function (api, module) {
        ...
        function serializePosition(node, offset, rootNode) {
            ...
            while (n && $(n).attr("class") != "main") {
                if (n.nodeType == 1 && $(n).attr("class") != "highlight" && $(n).attr("class") != "note" && $(n).attr("class") != "tag" && $(n).attr("class") != "annotation") {
        ...
        function deserializePosition(serialized, rootNode, doc) {
            ...
            while (i < nodeLevel) {
                if (nodeIndices[i] != "" && nodeIndices[i] != undefined && nodeIndices[i] != null) {
                    ...
                    while (j < node.childNodes.length) {
                        if (node.childNodes[j].nodeName == tagName) {
